...
var TableauReport = function (_React$Component) {
  ...
  _createClass(TableauReport, [{
    ...
    value: function getParameters(workbook) {
      ...
      // workbook.getParametersAsync().then(function(a) {console.log(a);});
      var promises = [];
      ...
      this.onComplete(promises, function (a) {
        ...
        for (var i = 0; i < a[0].length; i++) {
          console.log(a[0][i]);
          var parmName = a[0][i].getName();
          var parmValue = a[0][i].getCurrentValue();
          console.log(parmName);
          console.log(parmValue);
        }
        return _this2.setState({ loading: false, parameters: parms });
      });
    }
  }, {
    key: 'applyParameters',
